...
import contractStatus from './codes';
...
class ContractsTable extends React.Component {
    ...
    goToEdit =  async (contract) => {
        const { profile } = this.props;
        profile.setEditingContract(contract);
        await profile.update();
        this.props.history.push(`/${profile.getType()}/editContract`);
    }
                            ...
                            return (
                                ...
                                >
                                    ...
                                    <TableCell style={{width : 50}} align="center">
                                        <p className={contractStatus[n.state.toLowerCase()]}>
