            ...
            <Container>
                ...
                <Row>
                    <p className='text-initial_page'>
                        Welcome to the autonomous PBA smart-contract! Here you’ll be able to create payments that respect certain conditions, in order to make payments between contractor – contracted faster, simpler and more transparent.
                    <p>  
                ...
                <Row style={{marginTop : 50}} >
                    <Col lg={4}>
                        <ProfileCard enter={this.enter} type={'client'} image={client} name={'Client'} text={'The agent responsible for defining the contract rules and for making the payments'} />
                    </Col>
                    <Col lg={4}>
                    ...
                    <Col lg={4}>
                        <ProfileCard enter={this.enter} type={'company'} image={company} name={'Company'} text={'The agent responsible to execute the work defined in the smart-contract and receive the payments'} />
                    </Col>
                </Row>              
            </Container>
        )
